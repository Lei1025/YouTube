...
//  YouTube
//
//  Created by Lei Liu on 2018/3/10.
...
class VideoCell: BaseCell{
    ...
    var video : Video? {
        didSet {
            ...
            if let title = video?.title {
                let size = CGSize(width: frame.width - 16 - 44 - 8 - 16 - 10, height: 1000)
    ...
    let separatorView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(displayP3Red: 230/250, green: 230/250, blue: 230/350, alpha: 1)
        return view
    }()
    ...
    let subtitleTextView: UITextView = {
        ...
        textView.text = "TaylorSwiftVEVO - 1,604,648,607 view • 2 years ago"
